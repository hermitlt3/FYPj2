...
public class CollectibleHealth : CollectibleBehavior {
	...
	protected override void Update () {
		...
		if ((playerCollider.bounds.Contains (new Vector2(thisCollider.bounds.min.x, thisCollider.bounds.min.y)) &&
			...
			TextPopupManager.instance.ShowTextPopup (playerGO.GetComponentInChildren<Canvas> (), playerGO.transform.position, "+"+healthScript.GetCurrentHealth (), TextPopupManager.TEXT_TYPE.HEAL_PLAYER);
